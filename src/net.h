...
/** Compatibility base for the existing V1/V2 implementations. */
class Transport : public node::TransportChannel {};
...
public:
    ...
    const std::unique_ptr<node::TransportChannel> m_transport;
