...
// Work around an MSVC 19.x bug triggering C7595 when calling consteval
// constructors in initializer lists. The compiler bug is fixed in MSVC 20.x
// (Visual Studio 18.0).
    ...
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        m_assumeutxo_data = {
            {   // For use by unit tests
                ...
                .blockhash = consteval_ctor(uint256{"135eec25a6fb277884e5824e7aa7d052c4868161c99a5122170b5266f86c273d"}),
            },
            {
            ...
            },
            {
                ...
                .blockhash = consteval_ctor(uint256{"0c552ced4721c249a389eb9b08cb8da261cd46f0e7b5f9d064d48f3113406853"}),
            },
        };
